...
### Fixed
- Fixed slash commands not being displayed/registered for Antigravity 2.0 by updating the global commands directory to `~/.gemini/antigravity/commands/` and workspace commands to `.antigravity/commands/`.
